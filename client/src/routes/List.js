...
class List extends Component { state = { boards: [], }; 
              ...
              {boards.map((item) => {
                   ...
                   <ListItem key={item.id}>
                        ...
                        <p>{item.content}</p> </Link> 
                         ...
                         <Button> 
                             {/* <button onClick={handleClick}>get Request
                             </button> */}
                             ...
                             a { text-decoration: none; 
                                h3 { margin: 0; padding: 0; color: #212121; }
                                 p { margin: 0; padding: 10px 0 0 0; 
                                    color: #787878; } &:hover { h3 { color: #0066ff; } } } `; 
                                    const Button = styled.div` 
                                    border-top: 1px solid #eee;
                                     padding: 20px; 
                                    a { 
                                        float: right; padding: 10px 20px; border-radius: 5px; 
